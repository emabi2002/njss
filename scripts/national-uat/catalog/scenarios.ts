...
export const TRANSACTION_SCENARIOS: readonly TransactionScenario[] = [
  ...
  },
  {
    ...
    description: 'Staff training, judicial and administrative workshops, travel and supplier lifecycle workflow.',
    financeCodes: ['228-01', '228-02', '221-01', '221-02'],
    expectedWorkflowCoverage: ['SUPPLIER', 'FF3', 'COMMITMENT', 'FF4'],
  },
  {
    code: 'UAT-TXN-ALO',
    locationCode: 'MBA-ALO',
    description: 'Utilities, facilities maintenance, office furniture and routine FF3/FF4 processing.',
    financeCodes: ['231-01', '231-02', '233-01', '271-01'],
    expectedWorkflowCoverage: ['FF3', 'COMMITMENT', 'FF4', 'RECONCILIATION'],
  },
  {
    code: 'UAT-TXN-TAR',
    locationCode: 'HEL-TAR',
    description: 'Urgent operational expenditure, judicial travel, vehicle fuel and operating costs including insufficient-funding validation.',
    financeCodes: ['227-01', '227-02', '225-01', '225-02'],
    expectedWorkflowCoverage: ['FF3', 'FUNDING_CONTROL', 'INSUFFICIENT_FUNDS_REJECTION'],
  },
  {
    code: 'UAT-TXN-BUK',
    locationCode: 'ARB-BUK',
    description: 'Registry operations, circuit travel support, domestic airfares, funding allocation and regional reporting.',
    financeCodes: ['223-03', '227-02', '227-01', '221-01'],
