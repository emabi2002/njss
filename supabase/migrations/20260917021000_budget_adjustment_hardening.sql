-- =============================================================================
-- NJSS SIMPLIFIED BUDGET ADJUSTMENT HARDENING
-- Correct the reallocation request-time source-position comparison and keep the
-- authoritative financial-year predicate unambiguous.
-- =============================================================================
