...
export const MENU_ITEMS: RbacMenuItem[] = [
  ...
  { code: 'systems_administration.dashboard', module_code: 'systems_administration', label: 'Admin Dashboard', href: '/dashboard/admin/operations', icon: 'Gauge', sort_order: 10, required_permissions: ['dashboard.view', 'operations.view', 'operations.manage', 'settings.manage'], is_active: true },
...
export const ROUTE_PERMISSIONS: Array<{ pattern: RegExp; permissions: PermissionCode[] }> = [
  ...
  { pattern: /^\/dashboard\/admin\/operations($|\/)/, permissions: ['dashboard.view', 'operations.view', 'operations.manage', 'settings.manage', 'all'] },
