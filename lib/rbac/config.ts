...
export const MENU_ITEMS: RbacMenuItem[] = [
  ...
  { code: 'systems_administration.health', module_code: 'systems_administration', label: 'Systems Health', href: '/dashboard/admin/operations/health', icon: 'HeartPulse', sort_order: 20, required_permissions: ['operations.view', 'operations.manage', 'settings.manage'], is_active: true },
  ...
  { code: 'systems_administration.alerts', module_code: 'systems_administration', label: 'Systems Alert', href: '/dashboard/admin/operations/alerts', icon: 'Bell', sort_order: 60, required_permissions: ['operations.view', 'operations.manage', 'settings.manage'], is_active: true },
