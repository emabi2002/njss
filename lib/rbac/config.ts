...
export const MENU_ITEMS: RbacMenuItem[] = [
  ...
  { code: 'systems_administration.systems_operations_heading', module_code: 'systems_administration', label: 'Systems Operations', href: '#systems-operations', icon: 'Gauge', sort_order: 5, required_permissions: ['operations.view', 'operations.manage', 'settings.manage'], is_active: true },
