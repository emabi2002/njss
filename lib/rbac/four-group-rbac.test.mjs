...
const ff4ApprovalMigration = expectFile('supabase/migrations/20260906013000_ff4_registrar_approval_authority.sql')
...
await import(new URL('../../scripts/system-admin-organisation-setup.test.mjs', import.meta.url))
